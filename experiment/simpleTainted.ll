...
entry:
  ...
  store %Tstruct.Spl_json_value_t_t* %0, %Tstruct.Spl_json_value_t_t** %value.addr, align 8
...
cond.true:                                        ; preds = %entry
  %2 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %Tstruct.json_object_t_t* @json_value_get_object(%Tstruct.json_value_t_t* %value) #0 {
entry:
  %value.addr = alloca %Tstruct.Spl_json_value_t_t*, align 8
  %0 = bitcast %Tstruct.json_value_t_t* %value to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %0, %Tstruct.Spl_json_value_t_t** %value.addr, align 8
...
_Dynamic_check.succeeded:                         ; preds = %entry
  ...
  %call = call i32 @json_value_get_type(%Tstruct.Spl_json_value_t_t* %5)
  %cmp = icmp eq i32 %call, 4
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %_Dynamic_check.succeeded
  %6 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 8
...
_Dynamic_check.succeeded2:                        ; preds = %cond.true
  ...
  %11 = ptrtoint %Tstruct.Spl_json_value_value_t_t* %value3 to i32
...
_Dynamic_check.succeeded5:                        ; preds = %_Dynamic_check.succeeded2
  ...
  %15 = ptrtoint %Tstruct.Spl_json_value_value_t_t* %14 to i32
...
_Dynamic_check.succeeded7:                        ; preds = %_Dynamic_check.succeeded5
  %18 = bitcast i8* %16 to %Tstruct.Spl_json_value_value_t_t*
  ...
  %19 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %object8, align 8
  br label %cond.end
...
cond.end:                                         ; preds = %cond.false, %_Dynamic_check.succeeded7
  %cond = phi %Tstruct.Spl_json_object_t_t* [ %19, %_Dynamic_check.succeeded7 ], [ null, %cond.false ]
